...
export const COLOR_BLUE = '#5DA3C7';
...
export const COLOR_MAIN = '#F0D0BF';
...
export const NAV_BAR_START = '#FFFFFF';
export const NAV_BAR_END = '#FFF4F4';
export const SIDE_BAR_END = '#F0D0BF';
export const HEADER_BAR_START = '#DCB042';
export const HEADER_BAR_END = '#faeac4';
export const BUTTON_GRADIENT_START = '#FFE6E6';
export const BUTTON_GRADIENT_END = '#F0D0BF';
...
export const themes = {
	dark: {
		...
		navbarBackground: '#5D5D5A',
		headerBorder: '#080808',
		headerBackground: '#FFF4F4',
		headerSecondaryBackground: '#FFF4F4',
		headerTintColor: '#AD8B79',
		headerTitleColor: '#AD8B79',
		...
		buttonText: '#000000',
		messageOwnBackground: '#F7ECD2',
		messageOtherBackground: '#F4F4F4',
		modalBackground: '#E6E6E7',
		menuText: '#999999',
		sideTitleText: '#CB8E6E'
	}
};
